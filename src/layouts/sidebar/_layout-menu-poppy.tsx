...
import { menuItems } from '@/layouts/sidebar/_menu-items-poppy';
        ...
        <Fragment key={'layout' + item.name + index}>
          {item.href.length === 0 ? (
            <div className="relative mx-4 first:ml-0 last:mr-0">
              <Menu>
                <Menu.Button
                  ...
                  className="flex items-center text-sm font-medium capitalize text-gray-600 transition hover:text-gray-900 dark:text-gray-300 dark:hover:text-white 2xl:text-lg"
                >
                  {item.name}
                  <span
                    className={cn(
                      'z-[1] transition-transform duration-200 ltr:ml-3 rtl:mr-3',
                      showInfo ? 'rotate-180' : ''
                    )}
                  >
                    <ChevronDown />
            ...
            <ActiveLink
              ...
              className="mx-3 text-sm font-medium capitalize text-gray-600 transition first:ml-0 last:mr-0 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white 2xl:mx-3 2xl:text-lg 3xl:mx-4"
